...
{
    /// <summary>The maximum absolute latitude representable in the Web Mercator projection.</summary>
    public const double MaxMercatorLatitude = 85.05112878;

    /// <summary>
    /// Converts latitude/longitude to fractional tile coordinates at a given zoom level.
    /// The integer part is the tile index; the fractional part is the position within the tile.
    /// </summary>
