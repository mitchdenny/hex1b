...
internal sealed class DetailTextureBuilder : IDisposable
{
    ...
    /// <summary>
    /// Requests the detail texture be (re)built for <paramref name="window"/>. No-op if that block
    /// is already the most recent request. Runs asynchronously; returns immediately.
    /// </summary>
