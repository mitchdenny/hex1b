...
export async function loadFont(configuration: TerminalFont): Promise<LoadedFont> {
...
export interface NormalizedFont { family: string; faces: Required<TerminalFontFace>[] }
...
function isFontSet(value: unknown): value is Pick<FontFaceSet, "add" | "delete"> {
