...
/// ownership: it stays silent when the workload's
/// <see cref="IHex1bTerminalWorkloadAdapter.HandlesProtocolQueries"/> is
/// <see langword="true"/> (the remote producer owns replies), or the active presentation's
