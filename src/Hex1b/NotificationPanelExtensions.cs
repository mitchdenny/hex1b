...
{
    /// <summary>
    /// Creates a notification panel that displays floating notifications and a drawer.
    /// The panel uses the app-wide notification stack from the nearest ZStack ancestor.
