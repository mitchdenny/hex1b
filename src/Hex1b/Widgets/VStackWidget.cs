...
{
    public static readonly ActionId FocusNextAction = new($"{nameof(VStackWidget)}.{nameof(FocusNextAction)}");
    public static readonly ActionId FocusPreviousAction = new($"{nameof(VStackWidget)}.{nameof(FocusPreviousAction)}");
