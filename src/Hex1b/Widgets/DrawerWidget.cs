...
{
    public static readonly ActionId ToggleAction = new($"{nameof(DrawerWidget)}.{nameof(ToggleAction)}");
    public static readonly ActionId OpenAction = new($"{nameof(DrawerWidget)}.{nameof(OpenAction)}");
