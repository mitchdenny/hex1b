...
public static class Hex1bWidgets
{
    ...
    public static Task<Hex1bWidget> ButtonAsync(string label, Action onClick, CancellationToken cancellationToken = default) => Task.FromResult<Hex1bWidget>(new ButtonWidget(label, onClick));
}
