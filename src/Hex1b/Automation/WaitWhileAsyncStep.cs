...
/// <summary>
/// A step that waits while an async condition is true on the terminal.
/// Completes when the condition becomes false.
/// </summary>
public sealed record WaitWhileAsyncStep(
    ...
    string? Description = null) : TestStep
{
        ...
        CancellationToken ct)
    {
        ...
        var description = Description ?? "async condition to become false";
        throw new TimeoutException(
            $"WaitWhileAsync timed out after {Timeout} waiting for {description}.\n" +
