...
public static class CachingExtensions
{
    ...
    /// Predicate evaluated against the reconciled node. Returning <c>false</c> forces
    /// a cache miss for that subtree on the current frame.
    /// </param>
    /// <returns>A new widget with the cache predicate set.</returns>
    public static TWidget Cached<TWidget>(this TWidget widget, Func<Hex1bNode, bool> predicate)
