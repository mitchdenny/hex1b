...
public class SliderIntegrationTests : IDisposable
{
    ...
    public async Task Slider_RendersBasicSlider()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Volume Control"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_RendersAtMinimum()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Slider at minimum"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_RendersAtMaximum()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Slider at maximum"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_RendersWithStep()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Step slider"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_InHStackWithLabel()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Volume:"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_MultipleInVStack()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Effects:"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_InBorder()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Display Settings"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_ArrowKeysChangeValue()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Value: 50"), TimeSpan.FromSeconds(2))
            .Right().Right().Right()
    ...
    public async Task Slider_TabNavigatesToNextWidget()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Apply"), TimeSpan.FromSeconds(2))
            .Tab().Enter()
    ...
    public async Task Slider_CallbackTriggeredOnChange()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Callbacks:"), TimeSpan.FromSeconds(2))
            .Right().Right()
    ...
    public async Task Slider_RecordsMultipleSliders()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Audio Mixer"), TimeSpan.FromSeconds(2))
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Slider_MouseDragChangesValue()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Drag Test"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_MouseClickSetsValue()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Value: 0"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_DoubleWidthThumbCharacterRendersWithoutArtifacts()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Double-width"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_DoubleWidthThumbDragDoesNotLeaveArtifacts()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Drag double-width"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_InsideBorder_BorderEdgesAreAligned()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Border Test"), TimeSpan.FromSeconds(2))
    ...
    public async Task Slider_InsideBorder_WithDoubleWidthThumb_BorderEdgesAreAligned()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Double Width Test"), TimeSpan.FromSeconds(2))
