...
public class Hex1bMetricsTests
{
    ...
    public void Constructor_CreatesAllInstruments()
    {
        ...
        var expected = new[]
        {
            ...
            "hex1b.terminal.dcs.bytes",
            "hex1b.terminal.dcs.dispatches",
            "hex1b.terminal.dcs.cancellations",
            "hex1b.terminal.dcs.malformed_recoveries",
            "hex1b.terminal.dcs.retention_limit",
            "hex1b.terminal.raw_passthrough.duration",
            "hex1b.terminal.sixel.processing.duration",
            "hex1b.terminal.sixel.outcomes",
            "hex1b.terminal.sixel.resources",
            "hex1b.terminal.sixel.limit",
            "hex1b.hmp1.sixel.replay.duration",
            "hex1b.hmp1.sixel.replay.outcomes",
