...
public class TableNodeTests
{
    ...
    public async Task Integration_TableWithKeyboardScroll_WorksEndToEnd()
    {
        ...
        using var finalSnapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Product 1"), TimeSpan.FromSeconds(10), "Wait for table to render")
    ...
    public async Task Integration_TableInVStackWithButtons_ScrollingWorks()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Product 1"), TimeSpan.FromSeconds(10), "Wait for table")
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Integration_SelectionColumn_SpaceTogglesSelection()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Laptop"), TimeSpan.FromSeconds(10), "Wait for table to render")
            .Wait(100)
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
...
#pragma warning restore CS0067
    ...
    public async Task AsyncDataSource_NavigateDown_LoadsDataForNextRange()
    {
        ...
        // Wait for initial render
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Item 00001"), TimeSpan.FromSeconds(10), "Wait for table to render")
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task AsyncDataSource_AfterRender_ShowsFocusBarsOnFirstRow()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Item 00001"), TimeSpan.FromSeconds(10), "Wait for data to render")
    ...
    public async Task Table_WhenFocused_ShouldShowTableLevelFocusIndicator()
    {
        ...
        // Wait for render
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Item 1"), TimeSpan.FromSeconds(10), "Wait for table to render")
            .Wait(100)
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task LargeTable_Virtualized_ShouldHaveCorrectBorders()
    {
        ...
        // Wait for render
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Item 001"), TimeSpan.FromSeconds(10), "Wait for table to render")
            .Wait(100)
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Table_WithLargeSyncDataSource_ShouldShowScrollbar()
    {
        ...
        // Wait for initial render
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Product 00001"), TimeSpan.FromSeconds(10), "Wait for table to render")
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Table_WindowingDemoConfig_ScrollbarAdjacentToFixedColumns()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Alice Johnson") && s.ContainsText("Name"), TimeSpan.FromSeconds(10), "table rendered")
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Table_WindowingDemoConfig_TallWindow_NoScrollbarSameWidths()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Alice Johnson") && s.ContainsText("Jack Thomas"), TimeSpan.FromSeconds(10), "all rows rendered")
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Table_AllFixedColumns_ScrollbarAdjacentToContent()
    {
        ...
        // Wait for initial render
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Person 1") && s.ContainsText("Name"), TimeSpan.FromSeconds(10), "table rendered")
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Table_FixedColumnsWithoutScrollbar_ColumnWidthsMatchDefinitions()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Alice") && s.ContainsText("Name"), TimeSpan.FromSeconds(10), "table rendered")
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Table_MixedFixedAndFillColumns_FillAbsorbsRemainingSpace()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Item 1") && s.ContainsText("Name"), TimeSpan.FromSeconds(10), "table rendered")
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Table_AllFillColumns_WithScrollbar_NoGap()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Row 1") && s.ContainsText("Col A"), TimeSpan.FromSeconds(10), "table rendered")
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Table_FixedColumnsNarrowWidth_ScrollbarStillAdjacentWhenTableFillsWidth()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("R1"), TimeSpan.FromSeconds(10), "table rendered")
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Table_FixedColumnsWideTerminal_ScrollbarNotAtFarRightEdge()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("X1") && s.ContainsText("Col1"), TimeSpan.FromSeconds(10), "table rendered")
            .Build()
            .ApplyAsync(terminal, TestContext.Current.CancellationToken);
