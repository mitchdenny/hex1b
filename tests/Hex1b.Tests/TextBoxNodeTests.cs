...
public class TextBoxNodeTests
{
    ...
    public async Task Render_Unfocused_ShowsBrackets()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("[test]"), TimeSpan.FromSeconds(10), "bracketed text visible")
            .Capture("final")
            .Build()
    ...
    public async Task Render_Unfocused_EmptyText_ShowsEmptyBrackets()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("[]"), TimeSpan.FromSeconds(10), "empty brackets visible")
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Render_Unfocused_LongText_RendersCompletely()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("[This is a longer piece of text]"), TimeSpan.FromSeconds(10), "long text visible")
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Render_Focused_ShowsCursor()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("a") && s.ContainsText("b") && s.ContainsText("c"), 
                TimeSpan.FromSeconds(10), "text content visible")
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Render_Focused_CursorAtStart_HighlightsFirstChar()
    {
        ...
        // Wait for text content and capture snapshot atomically
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("hello"), TimeSpan.FromSeconds(10), "text content visible")
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Render_Focused_CursorAtEnd_ShowsCursorSpace()
    {
        ...
        // Wait for text content and capture snapshot atomically
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("test"), TimeSpan.FromSeconds(10), "text content visible")
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Render_Focused_EmptyText_ShowsCursorSpace()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("[") && s.ContainsText("]"), TimeSpan.FromSeconds(10), "brackets visible")
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Render_WithSelection_InMiddle_HighlightsCorrectPortion()
    {
        ...
        // Wait for text content and capture snapshot atomically
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("abcdefgh"), TimeSpan.FromSeconds(10), "text content visible")
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Integration_TextBox_RendersViaHex1bApp()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Initial Text"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Integration_TextBox_InNarrowTerminal_StillWorks()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            ...
            .End()
            .Type("X")
            .WaitUntil(s => s.ContainsText("ShortX"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Ctrl().Key(Hex1bKey.C)
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Integration_TextBox_TabBetweenMultiple()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            ...
            .Tab()
            .Type("XY")
            .WaitUntil(s => s.ContainsText("XY"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Ctrl().Key(Hex1bKey.C)
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Integration_TextBox_BackspaceWorks()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            ...
            .Backspace()
            .Backspace()
            .WaitUntil(s => s.ContainsText("te") && !s.ContainsText("test"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Ctrl().Key(Hex1bKey.C)
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Integration_TextBox_CursorNavigationWorks()
    {
        ...
        var runTask = app.RunAsync(TestContext.Current.CancellationToken);
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("abc"), TimeSpan.FromSeconds(10))
            .Home()
            .Right()
            .Type("X")
            .WaitUntil(s => s.ContainsText("aXbc"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Ctrl().Key(Hex1bKey.C)
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Integration_TextBox_SpecialCharactersWork()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.Terminal.InAlternateScreen, TimeSpan.FromSeconds(10))
            .Type("@!#")
            .WaitUntil(s => s.ContainsText("@!#"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Ctrl().Key(Hex1bKey.C)
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task Integration_TextBox_LongTextInNarrowTerminal_Wraps()
    {
        ...
        // Capture snapshot BEFORE exiting - after await runTask the alternate screen buffer is empty
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("[LongText"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
        await new Hex1bTerminalInputSequenceBuilder()
    ...
    public async Task Integration_TextBox_UncontrolledMode_MultipleTextBoxes_IndependentState()
    {
        ...
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            ...
            .Tab()
            .Type("BB")
            .WaitUntil(s => s.ContainsText("BB"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
        await new Hex1bTerminalInputSequenceBuilder()
    ...
    public async Task Integration_TextBox_ControlledMode_StillWorks()
    {
        ...
        var runTask = app.RunAsync(TestContext.Current.CancellationToken);
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("Initial"), TimeSpan.FromSeconds(10))
            .End()
            .Type("X")
            .WaitUntil(s => s.ContainsText("InitialX"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Ctrl().Key(Hex1bKey.C)
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task RunFirst_TextBox_SingleCharacterInput()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            ...
            .WaitUntil(s => s.ContainsText("a"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Ctrl().Key(Hex1bKey.C)
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task RunFirst_ButtonThenTextBox_TabToTextBox()
    {
        ...
        var runTask = app.RunAsync(TestContext.Current.CancellationToken);
        await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("OK"), TimeSpan.FromSeconds(10))
            .Tab()  // Move focus from Button to TextBox
            .Key(Hex1bKey.X)  // Type 'x' in TextBox
            .WaitUntil(s => s.ContainsText("x"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Ctrl().Key(Hex1bKey.C)
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task RunFirst_ButtonThenTextBox_JustTabThenExit()
    {
        ...
        var runTask = app.RunAsync(TestContext.Current.CancellationToken);
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("OK") && s.ContainsText("pre-filled"), TimeSpan.FromSeconds(10), "UI to render")
            .Tab()  // Move focus from Button to TextBox
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
    ...
    public async Task RunFirst_TextBoxInVStack_NoFocusChange()
    {
        ...
        // Wait for the text to appear (not just alternate screen) so we can verify it
        var snapshot = await new Hex1bTerminalInputSequenceBuilder()
            .WaitUntil(s => s.ContainsText("test-value"), TimeSpan.FromSeconds(10))
            .Capture("final")
            .Build()
            .ApplyWithCaptureAsync(terminal, TestContext.Current.CancellationToken);
        await new Hex1bTerminalInputSequenceBuilder()
